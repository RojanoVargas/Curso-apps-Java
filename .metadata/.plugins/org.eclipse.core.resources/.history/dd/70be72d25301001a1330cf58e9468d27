...
//Después sacar por pantalla los 3 coches del array. Hecho por Félix
// en MainCocheArray con pequeñas funciones.

//la función del booleano no funciona, y a partir del segundo coche hace cosas raras
...
//		c1.nuevo = sc2.nextBoolean();
		...
		//recorrer el array
		for(Coche nuevo: listaCoches1) {
			imprimirCoche2(nuevo);
